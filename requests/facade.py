...
class GameFacade:
    ...
    def get_all_battle_token(self) -> list[BattleToken]:
        return self.board and self.board.get_all_battle_token()

    def use_card(self, player_id) -> bool:
        return self.board and self.board.used_card(player_id)
    ...
    def do_execution_phase(self) -> bool:
        return self.board and self.board.execution_phase()
    ...
    def get_free_caste(self) -> list[Caste]:
        return self.board and self.board.get_free_caste()
    ...
    def get_possible_positions_control_token(self) -> list[int]:
        return self.board and self.board.get_possible_position_to_put_control_token()
